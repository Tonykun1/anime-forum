// src/app/[username]/page.tsx - עמוד פרופיל משתמש מתוקן עם NavBar
'use client';
...
import { ForumPostData as ForumPost, ApiPost, convertApiPostToForumPost } from '../../types';
...
const UserProfilePage: React.FC = () => {
  ...
  const handleCreatePost = async () => {
    // רענון הפוסטים אחרי יצירת פוסט חדש
    await fetchUserPosts();
    await fetchUserProfile(); // רענון הפרופיל לעדכון מספר הפוסטים
  };
  const handleCreatePostOpen = () => setIsCreatePostModalOpen(true);
      ...
      <AuthProvider>
        <div className={`min-h-screen ${themeClasses.bg}`}>
          <NavBar
            ...
            onCreatePost={handleCreatePostOpen}
